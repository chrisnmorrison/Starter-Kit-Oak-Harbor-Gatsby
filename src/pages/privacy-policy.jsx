...
const privacypolicy = () => {
  return (
    ...
    <div style={{padding: '5vw'}}>
      <h1>Privacy Policy for Open Education</h1>

      <p>
        At Open Education, accessible from openeducation.one, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Open
      ...
      <p>
        ...
        shared and/or collect in Open Education. This policy is not applicable
      ...
      <p>
        Open Education follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Open Education uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of Open Education.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Open Education, which are sent
      ...
      <p>
        Note that Open Education has no access to or control over these cookies
      ...
      <p>
        Open Education's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Open Education does not knowingly collect any Personal Identifiable
