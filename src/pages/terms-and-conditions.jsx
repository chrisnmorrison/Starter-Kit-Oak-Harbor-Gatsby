...
const termsandconditions = () => {
  return (
    ...
    <div style={{padding: '5vw'}}>
      ...
      <p>Welcome to Open Education!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Open Education's Website, located at openeducation.one.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Open Education if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Open Education, you agreed to
        use cookies in agreement with the Open Education's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Open Education and/or its licensors own the
        intellectual property rights for all material on Open Education. All
        intellectual property rights are reserved. You may access this from Open
        Education for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Open Education</li>
        <li>Sell, rent or sub-license material from Open Education</li>
        <li>Reproduce, duplicate or copy material from Open Education</li>
        <li>Redistribute content from Open Education</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Open
        Education does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Open Education,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Open Education
      ...
      <p>
        Open Education reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Open Education a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Open Education; and (d) the
      ...
      <p>
        ...
        e-mail to Open Education. Please include your name, your organization
      ...
      <p>
        No use of Open Education's logo or other artwork will be allowed for
